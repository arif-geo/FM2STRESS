...
#--------------------------------------------------------------------------
input_file = r'../Data/MTJ_manual_mechanisms_test.dat'

#--------------------------------------------------------------------------
# output file with results
#--------------------------------------------------------------------------
output_file = r'../Output/MTJ_manual_stress_output_TEST.'

# ASCII file with calculated principal mechanisms
principal_mechanisms_file = r'../Output/MTJ_manual_principal_mechanisms_TEST'
